...
class Hw2Env(environment.BaseEnv):
    def __init__(self, n_actions=8, **kwargs) -> None:
        ...
        theta = np.linspace(0, 2*np.pi, n_actions, endpoint=False) ###
    ...
    def step(self, action_id):
        ...
        # More interpolation steps reduce IK jitter and improve push consistency.
        self._set_ee_in_cartesian(target_pos, rotation=[-90, 0, 180], n_splits=20, threshold=0.03)
        self._t += 1
